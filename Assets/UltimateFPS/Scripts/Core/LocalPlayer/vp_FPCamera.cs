...
public class vp_FPCamera : vp_Component
{
	...
	protected virtual void UpdateZoom()
	{
		...
		gameObject.GetComponent<Camera>().fov = Mathf.SmoothStep(gameObject.GetComponent<Camera>().fov, RenderingFieldOfView, zoom);
	...
	public virtual void SnapZoom()
	{
		...
		gameObject.GetComponent<Camera>().fov = RenderingFieldOfView;
